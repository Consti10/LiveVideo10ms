...
namespace H264Stream{
    static std::string spsAsString(const sps_t* sps){
        ...
        if(sps->vui_parameters_present_flag){
            ss<<"VUI:[";
            ss<<"aspect_ratio_info_present_flag="<<sps->vui.aspect_ratio_info_present_flag<<",";
            ss<<"aspect_ratio_idc="<<sps->vui.aspect_ratio_idc<<",";
            ss<<"sar_width="<<sps->vui.sar_width<<",";
            ss<<"sar_height="<<sps->vui.sar_height<<",";
            ss<<"overscan_info_present_flag="<<sps->vui.overscan_info_present_flag<<",";
            ss<<"overscan_appropriate_flag="<<sps->vui.overscan_appropriate_flag<<",";
            ss<<"video_signal_type_present_flag="<<sps->vui.video_signal_type_present_flag<<",";
            ss<<"video_format="<<sps->vui.video_format<<",";
            ss<<"video_full_range_flag="<<sps->vui.video_full_range_flag<<",";
            ss<<"colour_description_present_flag="<<sps->vui.colour_description_present_flag<<",";
            ss<<"colour_primaries="<<sps->vui.colour_primaries<<",";
            ss<<"transfer_characteristics="<<sps->vui.transfer_characteristics<<",";
            ss<<"matrix_coefficients="<<sps->vui.matrix_coefficients<<",";
            ss<<"chroma_loc_info_present_flag="<<sps->vui.chroma_loc_info_present_flag<<",";
            ss<<"chroma_sample_loc_type_top_field="<<sps->vui.chroma_sample_loc_type_top_field<<",";
            ss<<"chroma_sample_loc_type_bottom_field="<<sps->vui.chroma_sample_loc_type_bottom_field<<",";
            ss<<"timing_info_present_flag="<<sps->vui.timing_info_present_flag<<",";
            ss<<"num_units_in_tick="<<sps->vui.num_units_in_tick<<",";
            ss<<"time_scale="<<sps->vui.time_scale<<",";
            ss<<"fixed_frame_rate_flag="<<sps->vui.fixed_frame_rate_flag<<",";
            ss<<"nal_hrd_parameters_present_flag="<<sps->vui.nal_hrd_parameters_present_flag<<",";
            ss<<"vcl_hrd_parameters_present_flag="<<sps->vui.vcl_hrd_parameters_present_flag<<",";
            ss<<"low_delay_hrd_flag="<<sps->vui.low_delay_hrd_flag<<",";
            ss<<"pic_struct_present_flag="<<sps->vui.pic_struct_present_flag<<",";
            ss<<"bitstream_restriction_flag="<<sps->vui.bitstream_restriction_flag<<",";
            ss<<"motion_vectors_over_pic_boundaries_flag="<<sps->vui.motion_vectors_over_pic_boundaries_flag<<",";
            ss<<"max_bytes_per_pic_denom="<<sps->vui.max_bytes_per_pic_denom<<",";
            ss<<"max_bits_per_mb_denom="<<sps->vui.max_bits_per_mb_denom<<",";
            ss<<"log2_max_mv_length_horizontal="<<sps->vui.log2_max_mv_length_horizontal<<",";
            ss<<"log2_max_mv_length_vertical="<<sps->vui.log2_max_mv_length_vertical<<",";
            ss<<"num_reorder_frames="<<sps->vui.num_reorder_frames<<",";
            ss<<"max_dec_frame_buffering="<<sps->vui.max_dec_frame_buffering;
            ss<<"]";
        }
        //ss<<"="<<sps-><<",";
        ss<<"]";
